...
describe('addItem / getAllItems', () => {
  it('adds an item and retrieves it', async () => {
    await addItem(env.DB, { name: 'Test Gift', link: null, image_url: null, emoji: null, price_min: 50, price_max: 50 })
...
describe('getItemsForFriend', () => {
  it('returns unclaimed items plus items claimed by the friend', async () => {
    const a = await addItem(env.DB, { name: 'A', link: null, image_url: null, emoji: null, price_min: null, price_max: null })
    const b = await addItem(env.DB, { name: 'B', link: null, image_url: null, emoji: null, price_min: null, price_max: null })
    const c = await addItem(env.DB, { name: 'C', link: null, image_url: null, emoji: null, price_min: null, price_max: null })
